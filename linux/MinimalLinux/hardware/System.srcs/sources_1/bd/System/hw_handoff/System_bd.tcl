...
proc create_root_design { parentCell } {
  ...
  set Buttons_Switches [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Buttons_Switches ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net AXI_Lite_M01_AXI [get_bd_intf_pins AXI_Lite/M01_AXI] [get_bd_intf_pins Buttons_Switches/S_AXI]
  connect_bd_intf_net -intf_net AXI_Lite_M02_AXI [get_bd_intf_pins AXI_Lite/M02_AXI] [get_bd_intf_pins LED/S_AXI]
  connect_bd_intf_net -intf_net Buttons_Switches_GPIO [get_bd_intf_ports Buttons] [get_bd_intf_pins Buttons_Switches/GPIO]
  connect_bd_intf_net -intf_net Buttons_Switches_GPIO2 [get_bd_intf_ports Switches] [get_bd_intf_pins Buttons_Switches/GPIO2]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_axi_periph_M00_AXI [get_bd_intf_pins AXI_Lite/M00_AXI] [get_bd_intf_pins XADC/s_axi_lite]
  ...
  connect_bd_net -net Buttons_Switches_ip2intc_irpt [get_bd_pins Buttons_Switches/ip2intc_irpt] [get_bd_pins IRQ/In0]
  connect_bd_net -net IRQ_dout [get_bd_pins IRQ/dout] [get_bd_pins ProcessingSystem/IRQ_F2P]
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXI_Lite/ACLK] [get_bd_pins AXI_Lite/M00_ACLK] [get_bd_pins AXI_Lite/M01_ACLK] [get_bd_pins AXI_Lite/M02_ACLK] [get_bd_pins AXI_Lite/S00_ACLK] [get_bd_pins Buttons_Switches/s_axi_aclk] [get_bd_pins LED/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins XADC/s_axi_aclk]
  connect_bd_net -net ProcessingSystem_FCLK_RESET0_N [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins Reset_ProcessingSystem/ext_reset_in]
  connect_bd_net -net XADC_alarm_out [get_bd_pins IRQ/In1] [get_bd_pins XADC/alarm_out]
  connect_bd_net -net XADC_ip2intc_irpt [get_bd_pins IRQ/In2] [get_bd_pins XADC/ip2intc_irpt]
  connect_bd_net -net rst_ProcessingSystem_100M_peripheral_aresetn [get_bd_pins AXI_Lite/ARESETN] [get_bd_pins AXI_Lite/M00_ARESETN] [get_bd_pins AXI_Lite/M01_ARESETN] [get_bd_pins AXI_Lite/M02_ARESETN] [get_bd_pins AXI_Lite/S00_ARESETN] [get_bd_pins Buttons_Switches/s_axi_aresetn] [get_bd_pins LED/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn] [get_bd_pins XADC/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Buttons_Switches/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs LED/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs XADC/s_axi_lite/Reg] -force
