...
set_property PACKAGE_PIN P18 [get_ports {Mute_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Mute_tri_o[0]}]

# LED
set_property PACKAGE_PIN M14 [get_ports {Mute_tri_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Mute_tri_o[1]}]
