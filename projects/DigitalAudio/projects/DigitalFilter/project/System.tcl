...
www.Kampis-Elektroecke.de:Kampis-Elektroecke:Filter:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: EnableFilter, and set properties
  set EnableFilter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 EnableFilter ]
  set_property -dict [ list \
  ...
  set Filter [ create_bd_cell -type ip -vlnv www.Kampis-Elektroecke.de:Kampis-Elektroecke:Filter:1.0 Filter ]

  # Create instance: IO, and set properties
  set IO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 IO ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net FIFO_AXI_STR_TXD [get_bd_intf_pins FIFO/AXI_STR_TXD] [get_bd_intf_pins Filter/DataIn]
  connect_bd_intf_net -intf_net Filter_DataOut [get_bd_intf_pins AXIS_I2S_Transmitter/AXIS_RXD] [get_bd_intf_pins Filter/DataOut]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_AXILite_M02_AXI [get_bd_intf_pins IO/S_AXI] [get_bd_intf_pins ProcessingSystem_AXILite/M02_AXI]
  connect_bd_intf_net -intf_net ProcessingSystem_AXILite_M03_AXI [get_bd_intf_pins EnableFilter/S_AXI] [get_bd_intf_pins ProcessingSystem_AXILite/M03_AXI]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_GPIO_0 [get_bd_intf_ports Mute] [get_bd_intf_pins ProcessingSystem/GPIO_0]
  connect_bd_intf_net -intf_net ProcessingSystem_IIC_0 [get_bd_intf_ports I2C] [get_bd_intf_pins ProcessingSystem/IIC_0]
  ...
  connect_bd_net -net EnableFilter_gpio_io_o [get_bd_pins EnableFilter/gpio_io_o] [get_bd_pins Filter/Enable]
  connect_bd_net -net FIFO_interrupt [get_bd_pins Concat_Interrupt/In0] [get_bd_pins FIFO/interrupt]
  connect_bd_net -net Mute_ip2intc_irpt [get_bd_pins Concat_Interrupt/In1] [get_bd_pins IO/ip2intc_irpt]
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXIS_I2S_Transmitter/ACLK] [get_bd_pins ClockingWizard/s_axi_aclk] [get_bd_pins EnableFilter/s_axi_aclk] [get_bd_pins FIFO/s_axi_aclk] [get_bd_pins Filter/ap_clk] [get_bd_pins IO/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins ProcessingSystem_AXILite/ACLK] [get_bd_pins ProcessingSystem_AXILite/M00_ACLK] [get_bd_pins ProcessingSystem_AXILite/M01_ACLK] [get_bd_pins ProcessingSystem_AXILite/M02_ACLK] [get_bd_pins ProcessingSystem_AXILite/M03_ACLK] [get_bd_pins ProcessingSystem_AXILite/S00_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk]
  ...
  connect_bd_net -net Reset_ProcessingSystem_peripheral_aresetn [get_bd_pins AXIS_I2S_Transmitter/ARESETn] [get_bd_pins ClockingWizard/s_axi_aresetn] [get_bd_pins EnableFilter/s_axi_aresetn] [get_bd_pins FIFO/s_axi_aresetn] [get_bd_pins Filter/ap_rst_n] [get_bd_pins IO/s_axi_aresetn] [get_bd_pins ProcessingSystem_AXILite/ARESETN] [get_bd_pins ProcessingSystem_AXILite/M00_ARESETN] [get_bd_pins ProcessingSystem_AXILite/M01_ARESETN] [get_bd_pins ProcessingSystem_AXILite/M02_ARESETN] [get_bd_pins ProcessingSystem_AXILite/M03_ARESETN] [get_bd_pins ProcessingSystem_AXILite/S00_ARESETN] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs EnableFilter/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs IO/S_AXI/Reg] -force
