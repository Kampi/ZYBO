...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Concat_Interrupt_dout [get_bd_pins Interrupt/dout] [get_bd_pins ProcessingSystem/IRQ_F2P]
  connect_bd_net -net EnableFilter_gpio_io_o [get_bd_pins EnableFilter/gpio_io_o] [get_bd_pins Filter/Enable]
  connect_bd_net -net FIFO_interrupt [get_bd_pins FIFO/interrupt] [get_bd_pins Interrupt/In0]
  connect_bd_net -net Mute_ip2intc_irpt [get_bd_pins IO/ip2intc_irpt] [get_bd_pins Interrupt/In1]
