...
proc create_root_design { parentCell } {
  ...
  set I2S [ create_bd_intf_port -mode Slave -vlnv www.kampis-elektroecke.de:Kampis-Elektroecke:I2S_rtl:1.0 I2S ]


  # Create ports
  set Enable [ create_bd_port -dir I Enable ]
  set MCLK [ create_bd_port -dir I -type clk -freq_hz 12288013 MCLK ]
  ...
  # Create instance: ProcessingSystem_AXI, and set properties
  set ProcessingSystem_AXI [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ProcessingSystem_AXI ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
 ] $ProcessingSystem_AXI
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXIS_I2S_Receiver_AXIS_TXD] [get_bd_intf_pins AXIS_I2S_Receiver/AXIS_TXD] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets AXIS_I2S_Receiver_AXIS_TXD]
  connect_bd_intf_net -intf_net AXI_DMA_M_AXI_S2MM [get_bd_intf_pins AXI_DMA/M_AXI_S2MM] [get_bd_intf_pins ProcessingSystem_AXI/S01_AXI]
  connect_bd_intf_net -intf_net AXI_DMA_M_AXI_SG [get_bd_intf_pins AXI_DMA/M_AXI_SG] [get_bd_intf_pins ProcessingSystem_AXI/S00_AXI]
  connect_bd_intf_net -intf_net Buttons_GPIO [get_bd_intf_ports Buttons] [get_bd_intf_pins Buttons/GPIO]
  connect_bd_intf_net -intf_net I2S_0_1 [get_bd_intf_ports I2S] [get_bd_intf_pins AXIS_I2S_Receiver/I2S]
  connect_bd_intf_net -intf_net ProcessingSystem_AXILite_M00_AXI [get_bd_intf_pins AXI_DMA/S_AXI_LITE] [get_bd_intf_pins ProcessingSystem_AXILite/M00_AXI]
  connect_bd_intf_net -intf_net ProcessingSystem_AXILite_M01_AXI [get_bd_intf_pins Buttons/S_AXI] [get_bd_intf_pins ProcessingSystem_AXILite/M01_AXI]
  connect_bd_intf_net -intf_net ProcessingSystem_AXI_M00_AXI [get_bd_intf_pins ProcessingSystem/S_AXI_HP0] [get_bd_intf_pins ProcessingSystem_AXI/M00_AXI]
  ...
  connect_bd_net -net Enable_0_1 [get_bd_ports Enable] [get_bd_pins AXIS_I2S_Receiver/Enable]
  ...
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXIS_I2S_Receiver/ACLK] [get_bd_pins AXI_DMA/m_axi_s2mm_aclk] [get_bd_pins AXI_DMA/m_axi_sg_aclk] [get_bd_pins AXI_DMA/s_axi_lite_aclk] [get_bd_pins Buttons/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins ProcessingSystem/S_AXI_HP0_ACLK] [get_bd_pins ProcessingSystem_AXI/ACLK] [get_bd_pins ProcessingSystem_AXI/M00_ACLK] [get_bd_pins ProcessingSystem_AXI/S00_ACLK] [get_bd_pins ProcessingSystem_AXI/S01_ACLK] [get_bd_pins ProcessingSystem_AXILite/ACLK] [get_bd_pins ProcessingSystem_AXILite/M00_ACLK] [get_bd_pins ProcessingSystem_AXILite/M01_ACLK] [get_bd_pins ProcessingSystem_AXILite/M02_ACLK] [get_bd_pins ProcessingSystem_AXILite/S00_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net Reset_ProcessingSystem_peripheral_aresetn [get_bd_pins AXIS_I2S_Receiver/ARESETn] [get_bd_pins AXI_DMA/axi_resetn] [get_bd_pins Buttons/s_axi_aresetn] [get_bd_pins ProcessingSystem_AXI/ARESETN] [get_bd_pins ProcessingSystem_AXI/M00_ARESETN] [get_bd_pins ProcessingSystem_AXI/S00_ARESETN] [get_bd_pins ProcessingSystem_AXI/S01_ARESETN] [get_bd_pins ProcessingSystem_AXILite/ARESETN] [get_bd_pins ProcessingSystem_AXILite/M00_ARESETN] [get_bd_pins ProcessingSystem_AXILite/M01_ARESETN] [get_bd_pins ProcessingSystem_AXILite/M02_ARESETN] [get_bd_pins ProcessingSystem_AXILite/S00_ARESETN] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces AXI_DMA/Data_SG] [get_bd_addr_segs ProcessingSystem/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces AXI_DMA/Data_S2MM] [get_bd_addr_segs ProcessingSystem/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs AXI_DMA/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Buttons/S_AXI/Reg] -force
