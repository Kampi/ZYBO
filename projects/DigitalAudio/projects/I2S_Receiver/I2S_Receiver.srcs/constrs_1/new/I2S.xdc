...
set_property PACKAGE_PIN U20 [get_ports LRCLK_Out]
set_property IOSTANDARD LVCMOS33 [get_ports LRCLK_Out]

set_property PACKAGE_PIN V20 [get_ports SCLK_Out]
set_property IOSTANDARD LVCMOS33 [get_ports SCLK_Out]

set_property PACKAGE_PIN W20 [get_ports SD_Out]
set_property IOSTANDARD LVCMOS33 [get_ports SD_Out]
