...
/* Definitions for peripheral VIDEODMA */
#define XPAR_VIDEODMA_DEVICE_ID 0U
#define XPAR_VIDEODMA_BASEADDR 0x43000000U
#define XPAR_VIDEODMA_HIGHADDR 0x4300FFFFU
#define XPAR_VIDEODMA_NUM_FSTORES 3U
#define XPAR_VIDEODMA_INCLUDE_MM2S 1U
#define XPAR_VIDEODMA_INCLUDE_MM2S_DRE 0U
#define XPAR_VIDEODMA_M_AXI_MM2S_DATA_WIDTH 32U
#define XPAR_VIDEODMA_INCLUDE_S2MM 0U
#define XPAR_VIDEODMA_INCLUDE_S2MM_DRE 0U
#define XPAR_VIDEODMA_M_AXI_S2MM_DATA_WIDTH 64U
#define XPAR_VIDEODMA_AXI_MM2S_ACLK_FREQ_HZ 0U
#define XPAR_VIDEODMA_AXI_S2MM_ACLK_FREQ_HZ 0U
#define XPAR_VIDEODMA_MM2S_GENLOCK_MODE 3U
#define XPAR_VIDEODMA_MM2S_GENLOCK_NUM_MASTERS 1U
#define XPAR_VIDEODMA_S2MM_GENLOCK_MODE 0U
#define XPAR_VIDEODMA_S2MM_GENLOCK_NUM_MASTERS 1U
#define XPAR_VIDEODMA_INCLUDE_SG 0U
#define XPAR_VIDEODMA_ENABLE_VIDPRMTR_READS 1U
#define XPAR_VIDEODMA_USE_FSYNC 1U
#define XPAR_VIDEODMA_FLUSH_ON_FSYNC 1U
#define XPAR_VIDEODMA_MM2S_LINEBUFFER_DEPTH 512U
#define XPAR_VIDEODMA_S2MM_LINEBUFFER_DEPTH 512U
#define XPAR_VIDEODMA_INCLUDE_INTERNAL_GENLOCK 1U
#define XPAR_VIDEODMA_S2MM_SOF_ENABLE 1U
#define XPAR_VIDEODMA_M_AXIS_MM2S_TDATA_WIDTH 24U
#define XPAR_VIDEODMA_S_AXIS_S2MM_TDATA_WIDTH 32U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_1 0U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_5 0U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_6 1U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_7 1U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_9 0U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_13 0U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_14 1U
#define XPAR_VIDEODMA_ENABLE_DEBUG_INFO_15 1U
#define XPAR_VIDEODMA_ENABLE_DEBUG_ALL 0U
#define XPAR_VIDEODMA_ADDR_WIDTH 32U
#define XPAR_VIDEODMA_ENABLE_VERT_FLIP 0U


/******************************************************************/

/* Canonical definitions for peripheral VIDEODMA */
#define XPAR_AXIVDMA_0_DEVICE_ID XPAR_VIDEODMA_DEVICE_ID
...
/* Definitions for peripheral VIDEOCLOCK */
#define XPAR_VIDEOCLOCK_DEVICE_ID 0
#define XPAR_VIDEOCLOCK_BASEADDR 0x43C10000
#define XPAR_VIDEOCLOCK_HIGHADDR 0x43C1FFFF
#define XPAR_VIDEOCLOCK_ENABLE_CLOCK_MONITOR 0
#define XPAR_VIDEOCLOCK_ENABLE_USER_CLOCK0 0
#define XPAR_VIDEOCLOCK_ENABLE_USER_CLOCK1 0
#define XPAR_VIDEOCLOCK_ENABLE_USER_CLOCK2 0
#define XPAR_VIDEOCLOCK_ENABLE_USER_CLOCK3 0
#define XPAR_VIDEOCLOCK_REF_CLK_FREQ 100.0
#define XPAR_VIDEOCLOCK_USER_CLK_FREQ0 100.0
#define XPAR_VIDEOCLOCK_USER_CLK_FREQ1 100.0
#define XPAR_VIDEOCLOCK_USER_CLK_FREQ2 100.0
#define XPAR_VIDEOCLOCK_USER_CLK_FREQ3 100.0
#define XPAR_VIDEOCLOCK_PRECISION 1
#define XPAR_VIDEOCLOCK_ENABLE_PLL0 0
#define XPAR_VIDEOCLOCK_ENABLE_PLL1 0
#define XPAR_VIDEOCLOCK_PRIM_IN_FREQ 125.000
#define XPAR_VIDEOCLOCK_NUM_OUT_CLKS 1


/******************************************************************/

/* Canonical definitions for peripheral VIDEOCLOCK */
#define XPAR_CLK_WIZ_0_DEVICE_ID XPAR_VIDEOCLOCK_DEVICE_ID
...
#define XPAR_INPUTS_BASEADDR 0x41200000
#define XPAR_INPUTS_HIGHADDR 0x4120FFFF
#define XPAR_INPUTS_DEVICE_ID 0
#define XPAR_INPUTS_INTERRUPT_PRESENT 1
...
#define XPAR_FABRIC_INPUTS_IP2INTC_IRPT_INTR 61U

/******************************************************************/

/* Canonical definitions for Fabric interrupts connected to ps7_scugic_0 */
#define XPAR_FABRIC_GPIO_0_VEC_ID XPAR_FABRIC_INPUTS_IP2INTC_IRPT_INTR
...
/* Definitions for peripheral VIDEOTIMING */
#define XPAR_VIDEOTIMING_DEVICE_ID 0
#define XPAR_VIDEOTIMING_BASEADDR 0x43C00000
#define XPAR_VIDEOTIMING_HIGHADDR 0x43C0FFFF
#define XPAR_VIDEOTIMING_GENERATE_EN 1
#define XPAR_VIDEOTIMING_DETECT_EN 0
#define XPAR_VIDEOTIMING_DET_HSYNC_EN 1
#define XPAR_VIDEOTIMING_DET_VSYNC_EN 1
#define XPAR_VIDEOTIMING_DET_HBLANK_EN 1
#define XPAR_VIDEOTIMING_DET_VBLANK_EN 1
#define XPAR_VIDEOTIMING_DET_AVIDEO_EN 1
#define XPAR_VIDEOTIMING_DET_ACHROMA_EN 0


/******************************************************************/

/* Canonical definitions for peripheral VIDEOTIMING */
#define XPAR_VTC_0_DEVICE_ID XPAR_VIDEOTIMING_DEVICE_ID
