...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ot_out [ create_bd_port -dir O ot_out ]
  set user_temp_alarm_out [ create_bd_port -dir O user_temp_alarm_out ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.TEMPERATURE_ALARM_RESET {35} \
   CONFIG.TEMPERATURE_ALARM_TRIGGER {40} \
  ...
  connect_bd_net -net Reset_ProcessingSystem_peripheral_reset [get_bd_pins Reset_ProcessingSystem/peripheral_reset] [get_bd_pins XADC/reset_in]
  connect_bd_net -net XADC_ot_out [get_bd_ports ot_out] [get_bd_pins XADC/ot_out]
  connect_bd_net -net XADC_user_temp_alarm_out [get_bd_ports user_temp_alarm_out] [get_bd_pins XADC/user_temp_alarm_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins XADC/dclk_in]
