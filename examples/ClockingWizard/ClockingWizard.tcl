...
#
# ClockingWizard.tcl: Tcl script for re-creating project 'ClockingWizard'
#
# Generated by Vivado on Wed Mar 25 10:38:25 +0100 2020
...
set _xil_proj_name_ "ClockingWizard"
...
set script_file "ClockingWizard.tcl"
...
proc cr_bd_System { parentCell } {
  ...
  # Create instance: AXILite_Peripheralss, and set properties
  set AXILite_Peripheralss [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 AXILite_Peripheralss ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $AXILite_Peripheralss
  ...
  connect_bd_intf_net -intf_net AXILite_Peripheralss_M00_AXI [get_bd_intf_pins AXILite_Peripheralss/M00_AXI] [get_bd_intf_pins ClockingWizard/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_M_AXI_GP0 [get_bd_intf_pins AXILite_Peripheralss/S00_AXI] [get_bd_intf_pins ProcessingSystem/M_AXI_GP0]
  ...
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXILite_Peripheralss/ACLK] [get_bd_pins AXILite_Peripheralss/M00_ACLK] [get_bd_pins AXILite_Peripheralss/S00_ACLK] [get_bd_pins ClockingWizard/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk]
  ...
  connect_bd_net -net Reset_Processor_peripheral_aresetn [get_bd_pins AXILite_Peripheralss/ARESETN] [get_bd_pins AXILite_Peripheralss/M00_ARESETN] [get_bd_pins AXILite_Peripheralss/S00_ARESETN] [get_bd_pins ClockingWizard/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-235,-193",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1010 -y 340 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1010 -y 360 -defaultsOSRD
preplace port Locked -pg 1 -lvl 4 -x 1010 -y 150 -defaultsOSRD
preplace port ClockOut -pg 1 -lvl 4 -x 1010 -y 170 -defaultsOSRD
preplace port Clock125 -pg 1 -lvl 0 -x 0 -y 260 -defaultsOSRD
preplace inst Reset_ProcessingSystem -pg 1 -lvl 1 -x 230 -y 160 -defaultsOSRD
preplace inst ProcessingSystem -pg 1 -lvl 1 -x 230 -y 380 -defaultsOSRD
preplace inst AXILite_Peripheralss -pg 1 -lvl 2 -x 610 -y 130 -defaultsOSRD
preplace inst ClockingWizard -pg 1 -lvl 3 -x 880 -y 160 -defaultsOSRD
preplace netloc Reset_Processor_peripheral_aresetn 1 1 2 460 250 760J
preplace netloc ProcessingSystem_FCLK_RESET0_N 1 0 2 30 280 430
preplace netloc clk_in1_0_1 1 0 3 NJ 260 NJ 260 770J
preplace netloc ClockingWizard_ClockOut 1 3 1 NJ 170
preplace netloc ProcessingSystem_FCLK_CLK0 1 0 3 20 270 440 10 760
preplace netloc ClockingWizard_locked 1 3 1 NJ 150
preplace netloc ProcessingSystem_FIXED_IO 1 1 3 NJ 360 NJ 360 NJ
preplace netloc ProcessingSystem_M_AXI_GP0 1 1 1 450 70n
preplace netloc ProcessingSystem_DDR 1 1 3 NJ 340 NJ 340 NJ
preplace netloc AXILite_Peripheralss_M00_AXI 1 2 1 N 130
levelinfo -pg 1 0 230 610 880 1010
pagesize -pg 1 -db -bbox -sgen -110 0 1130 480
"
}
...
if {[string equal [get_runs -quiet Synth] ""]} {
    create_run -name Synth -part xc7z010clg400-1 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet Impl] ""]} {
    create_run -name Impl -part xc7z010clg400-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run Synth
} else {
