...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Users/Daniel.Kampert/Desktop/Git/Zybo/Misc/Zybo.xml} \
  ...
  connect_bd_intf_net -intf_net AXILite_Peripheral_M00_AXI [get_bd_intf_pins AXILite_Peripherals/M00_AXI] [get_bd_intf_pins ClockingWizard/s_axi_lite]
  connect_bd_intf_net -intf_net AXILite_Peripherals_M01_AXI [get_bd_intf_pins AXILite_Peripherals/M01_AXI] [get_bd_intf_pins Switches/S_AXI]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_M_AXI_GP0 [get_bd_intf_pins AXILite_Peripherals/S00_AXI] [get_bd_intf_pins ProcessingSystem/M_AXI_GP0]
  connect_bd_intf_net -intf_net Switches_GPIO [get_bd_intf_ports Switches] [get_bd_intf_pins Switches/GPIO]

  # Create port connections
  connect_bd_net -net ClockingWizard_ClockOut [get_bd_ports ClockOut] [get_bd_pins ClockingWizard/ClockOut]
  connect_bd_net -net ClockingWizard_locked [get_bd_ports Locked] [get_bd_pins ClockingWizard/locked]
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXILite_Peripherals/ACLK] [get_bd_pins AXILite_Peripherals/M00_ACLK] [get_bd_pins AXILite_Peripherals/M01_ACLK] [get_bd_pins AXILite_Peripherals/S00_ACLK] [get_bd_pins ClockingWizard/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins Switches/s_axi_aclk]
  ...
  connect_bd_net -net Reset_Processor_peripheral_aresetn [get_bd_pins AXILite_Peripherals/ARESETN] [get_bd_pins AXILite_Peripherals/M00_ARESETN] [get_bd_pins AXILite_Peripherals/M01_ARESETN] [get_bd_pins AXILite_Peripherals/S00_ARESETN] [get_bd_pins ClockingWizard/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn] [get_bd_pins Switches/s_axi_aresetn]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports Clock125] [get_bd_pins ClockingWizard/clk_in1]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs ClockingWizard/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Switches/S_AXI/Reg] -force
