...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_ProcessingSystem_100M_peripheral_aresetn [get_bd_pins AXI_Peripherals/ARESETN] [get_bd_pins AXI_Peripherals/M00_ARESETN] [get_bd_pins AXI_Peripherals/S00_ARESETN] [get_bd_pins FIFO/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
