...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net FIFO_AXI_STR_TXD [get_bd_intf_pins FIFO/AXI_STR_RXD] [get_bd_intf_pins FIFO/AXI_STR_TXD]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_axi_periph_M00_AXI [get_bd_intf_pins AXILite_Peripherals/M00_AXI] [get_bd_intf_pins FIFO/S_AXI]

  # Create port connections
  connect_bd_net -net FIFO_interrupt [get_bd_pins FIFO/interrupt] [get_bd_pins ProcessingSystem/IRQ_F2P]
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXILite_Peripherals/ACLK] [get_bd_pins AXILite_Peripherals/M00_ACLK] [get_bd_pins AXILite_Peripherals/S00_ACLK] [get_bd_pins FIFO/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ProcessingSystem_100M_peripheral_aresetn [get_bd_pins AXILite_Peripherals/ARESETN] [get_bd_pins AXILite_Peripherals/M00_ARESETN] [get_bd_pins AXILite_Peripherals/S00_ARESETN] [get_bd_pins FIFO/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
