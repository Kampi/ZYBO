...
proc create_root_design { parentCell } {
  ...
  set Schalter [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Schalter ]


  # Create ports

  # Create instance: AXILite_Peripheral, and set properties
  set AXILite_Peripheral [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 AXILite_Peripheral ]
  ...
  # Create instance: Schalter, and set properties
  set Schalter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Schalter ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {4} \
 ] $Schalter
  ...
  connect_bd_intf_net -intf_net Schalter_GPIO [get_bd_intf_ports Schalter] [get_bd_intf_pins Schalter/GPIO]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins AXILite_Peripheral/S00_AXI] [get_bd_intf_pins ProcessingSystem/M_AXI_GP0]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXILite_Peripheral/M00_AXI] [get_bd_intf_pins Schalter/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins AXILite_Peripheral/M01_AXI] [get_bd_intf_pins LED/S_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXILite_Peripheral/ACLK] [get_bd_pins AXILite_Peripheral/M00_ACLK] [get_bd_pins AXILite_Peripheral/M01_ACLK] [get_bd_pins AXILite_Peripheral/S00_ACLK] [get_bd_pins LED/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins Schalter/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins AXILite_Peripheral/ARESETN] [get_bd_pins Reset_ProcessingSystem/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXILite_Peripheral/M00_ARESETN] [get_bd_pins AXILite_Peripheral/M01_ARESETN] [get_bd_pins AXILite_Peripheral/S00_ARESETN] [get_bd_pins LED/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn] [get_bd_pins Schalter/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Schalter/S_AXI/Reg] -force
