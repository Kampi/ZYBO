...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXILite_Peripherals/M00_AXI] [get_bd_intf_pins Switches/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins AXILite_Peripherals/M01_AXI] [get_bd_intf_pins LED/S_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXILite_Peripherals/ACLK] [get_bd_pins AXILite_Peripherals/M00_ACLK] [get_bd_pins AXILite_Peripherals/M01_ACLK] [get_bd_pins AXILite_Peripherals/S00_ACLK] [get_bd_pins LED/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins Switches/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins AXILite_Peripherals/ARESETN] [get_bd_pins Reset_ProcessingSystem/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXILite_Peripherals/M00_ARESETN] [get_bd_pins AXILite_Peripherals/M01_ARESETN] [get_bd_pins AXILite_Peripherals/S00_ARESETN] [get_bd_pins LED/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn] [get_bd_pins Switches/s_axi_aresetn]
