...
proc create_root_design { parentCell } {
  ...
  set AXI [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 AXI ]
  ...
  set AXI_FIFO_FFT_Config [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_fifo_mm_s:4.2 AXI_FIFO_FFT_Config ]
  set_property -dict [ list \
  ...
  # Create instance: ILA_Config, and set properties
  set ILA_Config [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 ILA_Config ]
  set_property -dict [ list \
   CONFIG.C_BRAM_CNT {0} \
  ...
  connect_bd_intf_net -intf_net AXI_DATA_WIDTH_FFT_CONFIG_M_AXIS [get_bd_intf_pins AXI_DATA_WIDTH_FFT_CONFIG/M_AXIS] [get_bd_intf_pins XFFT/S_AXIS_CONFIG]
connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_DATA_WIDTH_FFT_CONFIG_M_AXIS] [get_bd_intf_pins AXI_DATA_WIDTH_FFT_CONFIG/M_AXIS] [get_bd_intf_pins ILA_Config/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets AXI_DATA_WIDTH_FFT_CONFIG_M_AXIS]
  connect_bd_intf_net -intf_net AXI_DMA_M_AXIS_MM2S [get_bd_intf_pins AXI_DMA/M_AXIS_MM2S] [get_bd_intf_pins XFFT/S_AXIS_DATA]
  connect_bd_intf_net -intf_net AXI_DMA_M_AXI_MM2S [get_bd_intf_pins AXI/S01_AXI] [get_bd_intf_pins AXI_DMA/M_AXI_MM2S]
  connect_bd_intf_net -intf_net AXI_DMA_M_AXI_S2MM [get_bd_intf_pins AXI/S00_AXI] [get_bd_intf_pins AXI_DMA/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net AXI_Lite_M00_AXI [get_bd_intf_pins AXI_DMA/S_AXI_LITE] [get_bd_intf_pins AXI_Lite/M00_AXI]
  connect_bd_intf_net -intf_net AXI_Lite_M01_AXI [get_bd_intf_pins AXI_FIFO_FFT_Config/S_AXI] [get_bd_intf_pins AXI_Lite/M01_AXI]
  connect_bd_intf_net -intf_net Processing_System_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins ProcessingSystem/DDR]
  connect_bd_intf_net -intf_net Processing_System_0_M_AXI_GP0 [get_bd_intf_pins AXI_Lite/S00_AXI] [get_bd_intf_pins ProcessingSystem/M_AXI_GP0]
  connect_bd_intf_net -intf_net XFFT_M_AXIS_DATA [get_bd_intf_pins AXI_DMA/S_AXIS_S2MM] [get_bd_intf_pins XFFT/M_AXIS_DATA]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins AXI/M00_AXI] [get_bd_intf_pins ProcessingSystem/S_AXI_HP0]
  ...
  connect_bd_net -net AXI_DMA_mm2s_introut [get_bd_pins AXI_DMA/mm2s_introut] [get_bd_pins Interrupts/In1]
  connect_bd_net -net AXI_DMA_s2mm_introut [get_bd_pins AXI_DMA/s2mm_introut] [get_bd_pins Interrupts/In2]
  connect_bd_net -net AXI_FIFO_FFT_Config_interrupt [get_bd_pins AXI_FIFO_FFT_Config/interrupt] [get_bd_pins Interrupts/In0]
  connect_bd_net -net ProcessingSystem_FCLK_RESET0_N [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins SystemReset/ext_reset_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI/aclk] [get_bd_pins AXI_DATA_WIDTH_FFT_CONFIG/aclk] [get_bd_pins AXI_DMA/m_axi_mm2s_aclk] [get_bd_pins AXI_DMA/m_axi_s2mm_aclk] [get_bd_pins AXI_DMA/s_axi_lite_aclk] [get_bd_pins AXI_FIFO_FFT_Config/s_axi_aclk] [get_bd_pins AXI_Lite/ACLK] [get_bd_pins AXI_Lite/M00_ACLK] [get_bd_pins AXI_Lite/M01_ACLK] [get_bd_pins AXI_Lite/S00_ACLK] [get_bd_pins ILA_Config/clk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins ProcessingSystem/S_AXI_HP0_ACLK] [get_bd_pins SystemReset/slowest_sync_clk] [get_bd_pins XFFT/aclk]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins AXI_Lite/ARESETN] [get_bd_pins SystemReset/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins AXI/aresetn] [get_bd_pins AXI_DATA_WIDTH_FFT_CONFIG/aresetn] [get_bd_pins AXI_DMA/axi_resetn] [get_bd_pins AXI_FIFO_FFT_Config/s_axi_aresetn] [get_bd_pins AXI_Lite/M00_ARESETN] [get_bd_pins AXI_Lite/M01_ARESETN] [get_bd_pins AXI_Lite/S00_ARESETN] [get_bd_pins ILA_Config/resetn] [get_bd_pins SystemReset/peripheral_aresetn] [get_bd_pins XFFT/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins Interrupts/dout] [get_bd_pins ProcessingSystem/IRQ_F2P]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces AXI_DMA/Data_MM2S] [get_bd_addr_segs ProcessingSystem/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs AXI_FIFO_FFT_Config/S_AXI/Mem0] -force
