...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net AXI_FIFO_Data_interrupt [get_bd_pins AXI_FIFO_Data/interrupt] [get_bd_pins Interrupts/In1]
  connect_bd_net -net AXI_FIFO_FFT_Config_interrupt [get_bd_pins AXI_FIFO_FFT_Config/interrupt] [get_bd_pins Interrupts/In0]
  connect_bd_net -net Net [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins SystemReset/aux_reset_in] [get_bd_pins SystemReset/ext_reset_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_DATA_WIDTH_FFT_CONFIG/aclk] [get_bd_pins AXI_DATA_WIDTH_FFT_RX/aclk] [get_bd_pins AXI_DATA_WIDTH_FFT_TX/aclk] [get_bd_pins AXI_FIFO_Data/s_axi_aclk] [get_bd_pins AXI_FIFO_FFT_Config/s_axi_aclk] [get_bd_pins AXI_Lite/ACLK] [get_bd_pins AXI_Lite/M00_ACLK] [get_bd_pins AXI_Lite/M01_ACLK] [get_bd_pins AXI_Lite/S00_ACLK] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins SystemReset/slowest_sync_clk] [get_bd_pins XFFT/aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins AXI_DATA_WIDTH_FFT_CONFIG/aresetn] [get_bd_pins AXI_DATA_WIDTH_FFT_RX/aresetn] [get_bd_pins AXI_DATA_WIDTH_FFT_TX/aresetn] [get_bd_pins AXI_FIFO_Data/s_axi_aresetn] [get_bd_pins AXI_FIFO_FFT_Config/s_axi_aresetn] [get_bd_pins AXI_Lite/M00_ARESETN] [get_bd_pins AXI_Lite/M01_ARESETN] [get_bd_pins AXI_Lite/S00_ARESETN] [get_bd_pins SystemReset/peripheral_aresetn] [get_bd_pins XFFT/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins Interrupts/dout] [get_bd_pins ProcessingSystem/IRQ_F2P]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs AXI_FIFO_Data/S_AXI/Mem0] SEG_AXI_FIFO_Data_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs AXI_FIFO_FFT_Config/S_AXI/Mem0] SEG_AXI_FIFO_FFT_Config_Mem0
